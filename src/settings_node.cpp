...
struct toggleButton saft_blandare = {.state = false, .joy_last = false}; // Y
...
void pubData()
{
		p_data.data[0] = emergensy_stop.state;
		p_data.data[1] = emergensy_stop.state;
		p_data.data[2] = saft_blandare.state;
		p_data.data[3] = 0;
